...
/// Eat Veggies Activity (under Feed) — tap floating veggie bubbles (max 4).
/// 1 serving → 1 star. All 4 → 3 stars + 1 Magic Bean. Timer resets 4h.
class EatVeggiesScreen extends StatefulWidget {
  const EatVeggiesScreen({super.key});

  @override
  State<EatVeggiesScreen> createState() => _EatVeggiesScreenState();
}

class _EatVeggiesScreenState extends State<EatVeggiesScreen>
    with TickerProviderStateMixin {
  static const _idleVideoAsset =
      'assets/videos/feed/veggies/bao_not_eating_veggies.mp4';
  static const _eatingVideoAsset =
      'assets/videos/feed/veggies/bao_eating_veggies.mp4';
  ...
  Future<void> _tapBubble(int index) async {
    ...
    if (_eaten.length >= EatVeggiesRules.veggiesForFullReward) {
      setState(() => _celebrating = true);
      final reward = EatVeggiesRules.rewardForVeggies(_eaten.length);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: TTColors.veggiesCream,
      body: Stack(
        fit: StackFit.expand,
        children: [
          const DecoratedBox(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  Color(0xFFF1F8E9),
                  TTColors.veggiesCream,
                  TTColors.veggiesSoft,
                ],
              ),
            ),
          ),
                          ...
                          children: List.generate(EatVeggiesRules.maxVeggies,
                            ...
                            return Positioned(
                              ...
                              child: BounceButton(
                                ...
                                semanticLabel: 'Veggie bubble ${i + 1}',
                                child: VeggiesBubble(
                                  eaten: done,
...
/// Fresh veggie bubble — same glassy float language as [AppleBubble].
class VeggiesBubble extends StatelessWidget {
  const VeggiesBubble({super.key, required this.eaten, this.playing = false});
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  ...
                  colors: eaten
                      ? [
                          ...
                          TTColors.veggiesSoft.withValues(alpha: 0.55),
                          TTColors.veggiesWarm.withValues(alpha: 0.65),
                        ]
                      : [
                          Colors.white.withValues(alpha: 0.95),
                          TTColors.veggiesCream.withValues(alpha: 0.45),
                          TTColors.veggiesSoft.withValues(alpha: 0.55),
                        ],
                ...
                boxShadow: [
                  BoxShadow(
                    color: TTColors.veggiesWarm.withValues(alpha: 0.28),
                    blurRadius: 14,
            ...
            Icon(
              ...
              size: 34,
              color: eaten
                  ? TTColors.veggiesWarm.withValues(alpha: 0.95)
                  : TTColors.veggiesDeep,
            ),
            if (eaten)
              Positioned(
                right: -2,
